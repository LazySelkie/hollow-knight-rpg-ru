...
| Челюсти этого жука невероятно большие, они наносят 3 единицы урона, вместо 2, а также дают +2 к броску на захват или удержание врага. Огромные челюсти имеют Вес 1.
...
| Выберите любую обычную или необычную Склянку. В свой ход этот жук может потратить Выносливость , равную стоимости Припасов выбранной Склянки, чтобы получить Эффект Статуса на 2 очка. Если выбранная Склянка имеет Восстановление или Окружение+, ее Направленный или Проглоченный эффект может быть использован на этом жуке или нацелен на клетку этого жука. Это немедленно прекращает эффект статуса.
| Находясь под действием этого эффекта состояния, жук покрыт веществом и применяет свои Напрравленные эффекты к жукам в захвате, жукам с природным оружием ближнего боя; или применяет свои эффекты Окружения к клетке этого жука и только к ней.
| Когда жук с Выделениями получает урон, эффект Окружения Склянки применяется к соседним клеткам. Уклонение от эффекта как зоны действия требует 1 успеха. Восстанавливающие эффекты выделений применяются один раз за способность для каждого жука. Эффекты Склянки могут быть активированы только раз атакой или захватом. Жук невосприимчив к пагубному воздействию собственных выделений.
...
.. +2 переброса за каждую клешню или обе?
...
.. "3 единицы урона вместо 1 и 4 уже схваченным ими жукам" - можно ли сформулировать лучше? "Большие клешни" - в оригинале совпадает с названием черты или нет? Если да, тогда должны быть Огромные клешки для постоянства, по идее
...
.. Про использование оружия и щита - чекнуть сходна ли формулировка с Огромными клешнями, возможно это повторяющаяся фраза, в таком случае привести к одному виду. "хотя не могут получить другой, потратив повышение Характеристики" - перепроверить источник
...
.. Что значит "со временем наносит"? Это Отложенный Урон? Уточнить
...
.. Уточнить что значит "до любых других модификаций этой черты"
...
""""""""""""""""""""""""""
| +1 **Голод**, +1 **Жути**
| Эта жук очень пугающий и заставляет нервничать других жуков. Эту черту можно взять дважды.
...
.. Панцирь наверно с заглавной стоит писать
...
"""""""""""""""""
| +3 **Голод**, -0.5 **Привлекательность**
| Этому жуку не чуждо отчаяние, и он сделает все, чтобы дожить до завтра. Когда у этого жука 1 Сердце или меньше, его Скорость увеличивается на 2, и он получает +2 кубика на броски Впитывания.
...
.. Кажется, опять они-он, проверить оригинал, исправить. Возможно, стоит "с трудом выживает" переформулировать, а то сейчас звучит будто не что он привык к этим трудностям, а что ну вот прям еле-еле, не привык
.. Кстати, что конкретно значит "требуют меньше еды"? В оригинале тоже не уточняется, но что это такое механически-то?
...
.. Они-он. Тот же вопрос про "больше еды" - что это механически значит
...
| Если жук проваливает проверку, он получает штраф -1 кубик ко всем броскам кроме Впитывания и не может противостоять или приближаться к цели своего страха. Это продолжается, пока он не перестанет ощущать свой страх и не пройдет число раундов, равное числу успехов, из-за которых он провалил проверку Проницательности.

.. _traits_plucky:
Отважный
"""""""""""""""""
| +3 **Голод** +0.5 **Привлекательность**
| Этот жук имеет Запас 3 очков Отваги. Они позволяют перебросить кубик даже после броска. Отвага полностью восстановится если Жук отдохнёт с Сытостью 0 или выше.
| Максимальная отвага увеличивается на 1 очко за каждые два открытых слота черт, которые есть у жука.

.. Что значит "два открытых слота черт"? Типо незаполненных чертами? Стоит ли где-то написать что можно брать меньше 7 черт? Стоит ли сменить формулировку на "два незанятых слота черт"? Проверить
.. Также добавить примечание на основе этого обсуждения в Дискорде: Can you give Plucky rerolls to other bugs? It does say "any roll" - (Time for Crab — 29.04.2023) No
...
.. Мб не "рассматривать", а "взять"? В оригинале небось taken
...
.. Украшения? Есть ли более подходящее слово?
...
.. Почему "Запас Сытости"? Почему Запас и почему с заглавной? В оригинале reserve, а для Запасов используется pool. Т.е.это 100% не один из Запасов. Найти более подходящее слово
...
.. "ЖутИ", хотя обычно именительный падеж. Исправить
...
.. note:: 
   ...
   *Не все слабости очевидны, как, например, склонность ронять вещи, задевая их крыльями. Да, смотрю на тебя, Херкель. Узнай свои слабости, ведь их последствия могут разниться от неудобства до роковой ошибки.*
...
.. "за счет дополнительных затрат 5 Сытости" наверно лучше было бы, а то звучит будто траты х5 на это. А также пункт про отдых с Сытостью 0+ в оригинале звучит так: "Resting with 0 or greater Belly also fully heals all Primary and Secondary Attribute damage", т.е.это скорее урон характеристикАМ, а не от них
...
.. Мб "к сопротивлению передозировкЕ"
...
.. "иначе они удержаны на месте И теряют своё оставшееся движение", наверное
...
.. "эффективно" потому что effectively? Мб убрать его вообще
...
| Потомство Проклятых Пылью жуков может нести часть проклятия. Панцири этих жуков сухие, мелоподобные, мало чем отличающиеся от панциря оболочки и обладающие схожей прочностью. Показатель Панциря жука превращается в его значение Поглощения, хотя все еще может использоваться для проверок Панциря на сопротивление.
| Однако всякий раз, когда жук получает урон Сердца от атаки, его показатель Поглощения уменьшается на 1, до минимума 2. Эффекты, которые наносят урон Панцирю, вместо этого наносят урон Поглощению до минимума 1. Урон Поглощению исцеляется со скоростью 1 за каждый Отдых.
| Если бесплодный жук когда-нибудь умрет от голода, он немедленно станет :ref:`Оболочкой <husk>` с показателем Панциря, равным его текущему Поглощению, как если бы он был под действием Пыльного проклятия. Однако Пыльное проклятие дает ему врожденный иммунитет Оболочки к урону от песчаных бурь.

.. note:: Тюленье примечание: Последнее предложение про иммунитет относится и к (пока)живому Бесплодному жуку, а не только к Оболочке которой он становится после смерти

.. А вот к ЧЕМУ относится иммунитет...это, блин, вопрос, потому что в оригинале Sandstorms (прям с заглавной), и есть песчаные бури как погода, есть спелл Sandstorm, и есть спелл (кажется)Abrasion, который в качестве флейвора имеет песчаную бурю в описании. И в дискорде системы есть различные варианты ответа на вопрос "так к чему иммунен Бесплодный жук", и все не от разработчиков/модераторов, а от обычных пользователей, увы
...
""""""""""""""""""
| +4 **Голод**
| Панцирь жука отмечен спиралью, мистическим узором, который искажает магию вокруг него. Жук может потратить одну Душу, когда на него действует магический урон. Если он это сделает, он может сделать бросок на Впитывание.
| Жуки с Поглощением или Внешним панцирем, имеющим Поглощение, могут для этого броска использовать его значение вместо Панциря.
...
"""""""""""
| +1 **Голод**
| Тело этого жука тонкое или гибкое, способное протискиваться в небольшие пространства. Он может залезть в пространство, подходящее для жука на один размер меньше его без штрафов.
...
| Этот жук исключительно мал, и его Мощь и Вес уменьшены на 1. Этот жук не может брать другие Черты, влияющие на его показатель Силы. Из-за своего размера жук может поместиться в очень маленьком пространстве, и его легко не заметить, сосредоточив внимание на более серьёзных угрозах.
...
.. Второй абзац - исправить "рассматривает все оружие или щиты" на что-то более подходящее
...
^^^^^^^^^^^^^^^^^
| +1 **Голод**
| Хотя жук плохо приспособлен для передвижения по суше, его хвост позволяет быстро передвигаться в воде. Он не получает штрафа за уклонение в воде и имеет +3 к Скорости во время плавания.
...
○ Похититель Панциря
^^^^^^^^^^^^^^^^^^^^^^
| Внешний Панцирь этого жука не является частью его тела, а вместо этого жук использует найденные панцири, при условии, что они принадлежали жукам, которые хотя бы на 1 размер больше него. Такой Панцирь использует значение Панциря своего первоначального владельца для определения его Поглощения и прочности.
| Вес панциря равен значению Веса его прошлого владельца, хотя не учитывается в Нагрузке этого жука при ношении.
...
.. "не должен бросать" стоит переформулировать, чтобы было именно что не обязан, а не что запрещено
...
.. Мб убрать дублирование "позволяет"?
...
^^^^^^^^^^^^^^^^^^^^^
| +3 **Голод**
| Прежде чем этот жук закончит свой ход, используя защитный клубок, он может прокатиться до 5 клеток + Скорость по прямой. Если у него есть Черта :ref:`traits_spiky` или :ref:`Удар <traits_slam>`, он может совершить одну атаку одним из этих природных видов оружия, прежде чем закончить свой ход.
...
.. Мб убрать повторение "попытаться поглотить"?
...
| Мясо этого жука несъедобно и наносит 1 урон за каждые 10 восстановленной Сытости.
...
.. "1 урон окружению" - наверно, урон окружения? Environmental который

.. _traits_resistant:
Устойчивый
"""""""""""""""""
| +4 **Голод**
| Этот жук устойчив к какому-то типу урона. Выберите тип урона, выбранный с одобрения Мастера, например, «дробящий» или «огонь». Даже если урон обычно не впитывается, жук получает 4 куба, для его Впитывания. Если жук подвергается отрицательному Эффекту Статуса, связанному с его сопротивлением, жук может бросить 4к6, чтобы сопротивляться Запасу Эффекта Статуса или длительности, уменьшая его на количество успехов.
