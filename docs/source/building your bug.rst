...
""""""""""""""""""""""""""
| +1 **Голод**
| Этот жук обладает длинным игольчатым ртом. Это природное оружие, которое наносит 1 урон. Он обходит :ref:`Понижение Урона <dmg_reduction>` брони, и броски на :ref:`Поглощение <dmg_soaking>` против него делаются с -2. Если у жука есть черта :ref:`Кровосос <traits_bloodsucker>`, через свой хоботок он поглощает полное значение Сытости.
...
| При использовании лекарства или зелья, не предназначенных специально для этого типа жуков, бросьте кубик. При выпадении 1-2 оно не оказывает эффекта. При 3-4 оказывает обычный эффект. При 5-6 его эффект удваивается.
