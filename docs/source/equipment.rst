...
+-----------------------------------------------------------------------+
.. |Гвоздь-копье Особенность| replace:: Атакующий может перебросить один проваленный бросок. Атака сразу после Рывка, Прыжка или Удара с отскоком наносит +1 урон.
