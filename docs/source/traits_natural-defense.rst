...
| Если у этого жука также есть черта :ref:`traits_spiky`, она может получить модификацию Шипованный на эту черту, не тратя Характеристик.
...
^^^^^^^^^^^^^^^^^^^^^
| +3 **Голод**
| Прежде чем этот жук закончит свой ход, используя защитное скручивание, он может прокатиться до 5 клеток + Скорость по прямой. Если у него есть черта :ref:`traits_spiky` или Мощный Удар, он может совершить одну атаку одним из этих природных видов оружия, прежде чем закончить свой ход.
